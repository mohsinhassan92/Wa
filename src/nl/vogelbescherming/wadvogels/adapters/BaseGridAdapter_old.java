...
public class BaseGridAdapter_old extends ArrayAdapter<Drawable> {
	...
	public BaseGridAdapter_old(Context context, int gridItemLayout, int imageView, List<Drawable> objects, 
		...
		this(context, gridItemLayout, imageView, objects, maxItemSelected, columnNumber, selectedItems,text, handler);
		...
		if (drawable != null) {
			...
			if (columnNumber == 3){ /*padding*/
				if (padding){
					...
					widthInPixels = (mMetrics.widthPixels/columnNumber)-getPixels(10, mMetrics);
				}
...
//				}
	        	...
	        	if (backing.getLayoutParams() != null)
	        		...
	        		backing.setLayoutParams(new AbsListView.LayoutParams(AbsListView.LayoutParams.MATCH_PARENT, heightInPixels));
	        	//backing.getLayoutParams().height = heightInPixels;
	        }
		...
		v.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				RelativeLayout backing = (RelativeLayout) v.findViewById(R.id.backing);
...
//						else
					...
					if (maxItemSelected == 1) {
						...
						//    Log.d("HAI 2 Member name: ", "HAI 2 Member name: "+Integer.toString(selectImagePositions.get(j)));
						//}
					...
					//    Log.d("HAI 3 Member name: ", "HAI 3 Member name: "+Integer.toString(selectImagePositions.get(j)));
					//}
