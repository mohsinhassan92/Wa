...
public class MapActivityOld extends ContentBaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (Utils.isOnline(this)) {
			for (String code : locationCodes) {
				...
				Log.i("MapActivityOld", "Location before\n" + code);
	...
	private void setUpMap() {
		...
		mMap.setInfoWindowAdapter(new InfoWindowAdapter() {
			...
			public View getInfoContents(final Marker marker) {
				...
				isInfoWinShown = true;
				if (Utils.isOnline(MapActivityOld.this) && (code.equals("TEXNZE") || code.equals("VLIELHVN") || code.equals("TERSLNZE") || code.equals("NES")
					...
					if (list != null) {
						...
						la = new TideTimeAdapter(MapActivityOld.this, list);
						listView.setAdapter(la);
					}
					if(BaseActivity.isTablet(MapActivityOld.this))
					{
